                ...
                <table width="600" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding: 0 40px 30px 40px; text-align: left;">
                            ...
                            <p
                                ...
                                Referente ao projeto <strong>{{ $bolsa->projeto_nome }} -
                                    {{ $bolsa->projeto_num }}</strong>, solicitamos que comunique ao bolsista
                                <strong>{{ $bolsistaNome }}</strong> que é imprescindível o preenchimento de seus dados
                                cadastrais e o anexo da documentação solicitada através do link abaixo:
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 0 40px 30px 40px; text-align: center;">
                            <a href="{{ route('bolsistas.registrar', ['bolsa_token' => $bolsa->token]) }}"
                                target="_blank"
                            ...
                            <div style="background-color: #edf2f7; border-left: 4px solid #3490dc; padding: 20px;">
                                ...
                                <ul
                                    ...
                                    <li style="margin-bottom: 15px;">
                                        É necessário enviar mensalmente o <strong>atestado de frequência</strong>
                                        (modelo em anexo) de todos os bolsistas.
                                    </li>
                                    <li style="margin-bottom: 15px;">
                                        Em virtude às exigências da FAPEMIG, as assinaturas nos atestados de frequência
                                        devem ser <strong>digitais ou manuais</strong> (nesse caso, com envio da cópia
                                        escaneada), para evitar problemas com assinaturas editadas.
                                    </li>
                                    <li>
                                        A documentação inicial deve ser enviada <strong style="color: #e53e3e;">até o
                                            dia 20 de cada mês</strong>. O não cumprimento do prazo implicará no não
